...
import { Designingstacks } from "./designingstacks";
    ...
    <>
      <div className="about center">
        <h1 data-aos="fade-right" className="mobileHead">
          Hello, I am <span className="about__name">Yugal Nemade</span>
        </h1>
        <Type />
        <p className="about__desc" data-aos="fade-right">
          ...
          learn new one to complete challenges and enhnace creativity. Also I have completed
          5+ projects till now.
        </p>
        ...
        <button
          ...
          onClick={() => {
            window.open(
              "https://drive.google.com/file/d/1xPHeR-bzIkhO9t-_MmEaS9x_mWJCiMqc/view?usp=share_link"
            );
          }}
        >
          Resume
